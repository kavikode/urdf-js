(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/get'), require('three'), require('@babel/runtime/helpers/wrapNativeSuper'), require('three/examples/js/controls/OrbitControls'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/slicedToArray'), require('three/examples/jsm/loaders/STLLoader.js'), require('three/examples/jsm/loaders/ColladaLoader.js'), require('three-mesh-bvh')) :
    typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/get', 'three', '@babel/runtime/helpers/wrapNativeSuper', 'three/examples/js/controls/OrbitControls', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/slicedToArray', 'three/examples/jsm/loaders/STLLoader.js', 'three/examples/jsm/loaders/ColladaLoader.js', 'three-mesh-bvh'], factory) :
    (global = global || self, global.URDFManipulator = factory(global._toConsumableArray, global._classCallCheck, global._possibleConstructorReturn, global._createClass, global._inherits, global._getPrototypeOf, global._get, global.THREE, global._wrapNativeSuper, global.THREE, global._typeof, global._slicedToArray, global.THREE, global.THREE, global.THREE));
}(this, function (_toConsumableArray, _classCallCheck, _possibleConstructorReturn, _createClass, _inherits, _getPrototypeOf, _get, THREE, _wrapNativeSuper, OrbitControls, _typeof, _slicedToArray, STLLoader_js, ColladaLoader_js, threeMeshBvh) { 'use strict';
